...
![](images1/dashboardgif.gif){width="100%" fig-align="center" fig-alt="Shiny python dashboard example"}
...
![](Images1/taylorswift_fullfan_gif.gif){width="60%" fig-align="center" fig-alt="Roy Kent saying - Please stop"}
...
ui.input_slider("n2", "N", 50, 100, 70)

@render.text
def txt2():
    return f"n2*3 is {input.n() * 3}"
...
<br>
![](images1/appbasic_expressexample.png){width="100%" fig-align="center" fig-alt="Shiny python dashboard example"}
:::
:::
...
::: {.fragment}
![](Images1/i-am-calm-taylor-swift-me.gif){width="100%" fig-align="center" fig-alt="Roy Kent saying - Please stop"}
:::
...
![](Images1/shinycorefaqstays.png){width="100%" fig-align="center" fig-alt="Roy Kent saying - Please stop"}
:::
...
![](Images1/shinycore_forcomplex.png){width="100%" fig-align="center" fig-alt="Roy Kent saying - Please stop"}
:::
...
![](Images1/shinyexpressandcore.png){width="50%" fig-align="center" fig-alt="Roy Kent saying - Please stop"}
:::
...
![](Images1/taylorscreaming.gif){width="100%" fig-align="center" fig-alt="TSwift screaming"}

## Resources


-   **Everything related to this presentation**
    -   [Link to presentation](https://deepshamenghani.quarto.pub/shiny-for-python-slides)
...
-   **Additional Peeps, resources and events to follow**
    ...
    -   [Upcoming Shiny Express webinar](https://youtu.be/_f3latmOhew?si=mOhOPI__32XcmveT)
    -   [Shiny for python](https://www.youtube.com/live/yvi5uXQMvu4?si=smcZL2BJqlrlm_a6)
    -   [Deploying Shiny for Python application](https://www.youtube.com/live/hbf7Ai3jnxY?si=t6hHleQe-4sbr7pE)
